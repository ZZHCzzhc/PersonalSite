...
public class EncryptDesService {
    ...
    public EncryptDesService() throws Exception {
    ...
    public EncryptDesService(String strKey) throws Exception {
    ...
    private static String strDefaultKey = "SaltyFish@#$%^&";
...
//            String msg1 = "1";
//
//            EncryptDesService des1 = new EncryptDesService();// 使用默认密钥
//
...
//
//            EncryptDesService des2 = new EncryptDesService(key);// 自定义密钥
//
